...
<footer class="main-footer">
	...
	<div class="float-right d-none d-sm-inline">
		<strong>Copyright &copy; 2022 DIANA LAUNDRY</strong>
	</div>
	<!-- Default to the left -->
	<strong>DIANA LAUNDRY</strong>
</footer>
</div>
<!-- ./wrapper -->
...
if ($u1 == "dashboard" || $u2 == "dashboard/index") :
?>
	<script>
		...
		$(function() {
			...
			var ctx = document.getElementById("laundry-chart");
